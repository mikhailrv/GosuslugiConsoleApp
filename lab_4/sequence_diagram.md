...
AuthenticationController уведомляет пользователя об ошибке.

•	Неверный пароль:

При несоответствии пароля AuthenticationService возвращает ошибку неправильного пароля.

AuthenticationController сообщает пользователю о неверном пароле.
...
ApplicationController возвращает сообщение об ошибке.
