...
![image](https://github.com/user-attachments/assets/7ed5abab-6591-4c66-a626-e781e7f503d6)
...
## 2.	Создание услуги
![image](https://github.com/user-attachments/assets/67b90eac-7ecd-4ea8-9168-9dc37452ac7f)
...
![image](https://github.com/user-attachments/assets/cacf8d61-5689-40cf-937b-8f563e98189e)
...
8.	ServiceRepository отправляет запрос на  создание новой услуги с данными старой услуги и startdate = enddate(из старой услуги).
...
12.	RuleRepository делает запрос на получение новых правил из базы данных.
...
Бд возвращает пустое значение для услуги(ничего не найдено).

Значение null передается вплоть до AdminController.
...
![image](https://github.com/user-attachments/assets/04f9ca74-dd48-4c87-8af8-a623fbb79c14)
...
![image](https://github.com/user-attachments/assets/9250bcd5-deef-4a72-900c-16df752e3094)
